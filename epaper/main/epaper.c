...
void epaper_task(void *arg) {
	...
	UBYTE *BlackImage;
	/* you have to edit the startup_stm32fxxx.s file and set a big enough
	 * heap size */
	UWORD Imagesize =
	...
	for (;;) {
		...
		Paint_ClearWindows(0, 0, Font20.Width * 7, Font20.Height,
		                   WHITE);
		...
		EPD_7IN5_V2_Display_Part(BlackImage, 150, 80,
		                         150 + Font20.Width * 7,
		                         80 + Font20.Height);
